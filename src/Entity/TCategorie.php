...
class TCategorie
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=TArticle::class, mappedBy="fk_categorie")
     */
    private $tArticles;
    ...
    public function removeTArticle(TArticle $tArticle): self
    {
        if ($this->tArticles->removeElement($tArticle)) {
            ...
            if ($tArticle->getFkCategorie() === $this) {
                $tArticle->setFkCategorie(null);
            }
        }
